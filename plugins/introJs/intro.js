...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      ...
      skipLabel: '<i class="fa fa-check" ></i>',
  ...
  */
  ...
  function _showElement(targetElement) {
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      prevTooltipButton.className = 'introjs-prevbutton introjs-hidden';
      ...
      nextTooltipButton.className = 'btn introjs-nextbutton introjs-disabled introjs-hidden';
